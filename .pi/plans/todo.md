...
- [ ] Add `package.json` and `scripts/validate-pi-package.js`.
...
- [ ] Add nine Pi-native files under `prompts/`.
...
- [ ] Add the Pi orchestration skill, task-fit persona, and `docs/pi-setup.md`.
